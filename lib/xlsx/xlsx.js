...
class XLSX {
  ...
  prepareModel(model, options) {
    ...
    // Support stylesCacheMode option for performance optimization
    const stylesOptions = options.stylesCacheMode ? {cacheMode: options.stylesCacheMode} : true;
    model.styles = model.useStyles ? new StylesXform(stylesOptions) : new StylesXform.Mock();
