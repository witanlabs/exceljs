...
class Cell {
  ...
  // Clone style before modification to avoid affecting cells that share the same style object
  // (e.g., cells loaded from a file or merged cells)
  _applyStyle(name, value) {
    this.style = {...copyStyle(this.style), [name]: value};
  }
